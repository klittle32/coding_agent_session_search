...
//!
//! cass advertises support for **25 coding-agent providers**: aider, amp,
...
//! letta_code, openclaw, opencode, openhands, pi_agent, qwen, vibe. Each is a
...
//!      connectors[].name` exactly equals the documented set of 25.
...
/// The canonical set of 25 documented provider connectors. Sourced from the
